...
model_path = "roadaccidentati.pkl"
...
def home():
    ...
    <head>
        ...
        <style>
            body { font-family: Arial, sans-serif; text-align: center; margin: 50px; background-color: rgb(53, 98, 117); }
...
def predict():
    try:
        ...
        print(probability)  # Output the percentage

        return jsonify({"result": int(probability_percentage)})  # Convert to percentage
